# *C. difficile* Toxin Cytotoxcity Titer Assay 
## by Jhansi Leslie from a protocol originally written by [Cassie Schumacher](https://www.linkedin.com/in/cassie-schumacher-2542595)
...
6. Resuspend the cells in 3mL of fresh supplemented DMEM
	+ As a rule you need 3mL fresh media per flask of cells 
...
3. Count the number of viable cells (not blue) in the corners of the hemocytometer highlighted in yellow, remember to count cells on the line for the top and right sides of the square only 
<div style="text-align:center"><img src ="https://github.com/SchlossLab/Jenior_Modeling_mBio_2017/blob/master/protocols/toxin_assay/hemocytometer%20.jpg?raw=true" width="100" height="100" /></div> 
...
3. Add 80uL of PBS to the rest of the wells on the plate
4. Make 1:5 serial dilutions across the plate (see plate map bellow) 
<div style="text-align:center"><img src ="https://github.com/SchlossLab/Jenior_Modeling_mBio_2017/blob/master/protocols/toxin_assay/Toxinassay_dilutionplate1_Jenior_mBio.jpg?raw=true" width="500" height="300" /></div> 


#### Create Dilution plate #2 (this plate is for the addition of  anti-toxin Ab to the sample)
1. Label all wells with their dilution 
...
<div style="text-align:center"><img src ="https://github.com/SchlossLab/Jenior_Modeling_mBio_2017/blob/master/protocols/toxin_assay/Toxinassay_dilutionplate2_Jenior_mBio.jpg?raw=true" width="500" height="300" /></div> 

5. Once all samples have been added incubate for 40 min  at room temperature so anti-toxin antibodies in sera can bind/inactivate the toxin. 
...
1. Remember, the dilution factor changes by a factor of 10 when added to Vero cells (1/20 -‐> 1/200)
...
5. Toxin Titer:  log [reciprocal of the final dilution factor]/ per gram of cecal content.

	```
		Toxin activity calculation: 
		Say the last well with 80% or more of the cells round  for mouse #1 was A2 and A5 (see plate maps above).
		This corresponds to the 10^-3 dilution in both replicate A and B. 
		If replicate A and B were discordant then we would take the average value. 
		Total dilution of mouse #1 sample = 1/50 (dilution of well #2 in plate 1) * 1/2 (addition of sample to PBS, dilution plate 2) * 1/10 (addition of sample to vero cells)  = 1/1000 
		Toxin activity = Log10 (1/(1/1000)) = 3 
