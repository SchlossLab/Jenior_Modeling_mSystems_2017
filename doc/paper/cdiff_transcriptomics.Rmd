...
- Different antibiotics result in different community structures, cite alyx's first mouse paper
- each unique community may present a unique set of circumstances that C. difficile must cope with in order to successfully infect the new host.
...
$$+/-\sqrt{\Big| \frac{\sum_{} T_i}{e_{o}} - \frac{\sum_{} T_o}{e_{i}} \Big|}$$
...
As timing of sporulation has been linked to environmental cues for metabolism such as glucose or glycine concentrations ().  With this in mind, differential plating was performed to determine the load of both spores and vegetative cells respectively in each treatment condition.  This was accomplished by first plating on agar media without the primary C. difficile germinant taurocholate to enumerate vegetative cells exclusively.  Immediately following was a 30 minute 65 C heat treatment to eliminate vegetative cells, and plating on media containing taurocholate. 

No difference in vegetative cell load was found in any susceptible condition tested.  However, significantly more (p=0.00012) spores were detected in gnotobiotic mice than in amy other the antibiotic treated conventional mice.
...
Table 1 – Antibiotic classes and effect



figure 1 – experimental design and antibiotic treatment timelines


figure 2 – C. difficile sporulation and toxin production are varied by treatment
...
figure 3 – C. difficile gene expression is different across susceptible communities



figure 4 - specific gene vs germ free plot


figure 4 – Metabolite utilization by C. difficile appears different across environments

figure 5 – in vitro validation of top hits from metabolic networks
...
C. difficile Toxin Assay  Vero cell cytotoxicity assay was performed on mouse cecal content as previously described (Leslie, 2014).
...
Protocols, code, and data availability
