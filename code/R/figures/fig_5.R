...
pdf(file=plot_file, width=10, height=14.5)
...
par(mar=c(7,7,1.5,2), las=1, cex.lab=2, cex.axis=1.8, xpd=FALSE, mgp=c(4,2,0), xaxs='r')
plot(0, type='n', xaxt='n', yaxt='n', xlim=c(1,37), ylim=c(-0.03,1.0), lwd=3, pch=15, xlab='Time (hours)', ylab=expression(OD[600]), cex=2.3)
...
legend('topleft', legend=c('No Carbohydrates','No Amino Acids','N-Acetyl-D-glucosamine','D-Sorbitol', 'Mannitol','Salicin','N-Acetylneuriminate'), 
       ...
       pch=c(15,19,6,0,1,2,5), cex=1.8, pt.cex=c(2.5,2.5,3.4,3.4,3.4,3.4,3.4), lwd=3, bg='white')
...
segments(x0=seq(1,37,1)-0.2, y0=growth_medians$no_carb_median-growth_sds$no_carb_sd, 
         x1=seq(1,37,1)+0.2, y1=growth_medians$no_carb_median-growth_sds$no_carb_sd, lwd=2.5, col='black')
lines(growth_medians$no_aa_median, type='o', lwd=3, pch=19, cex=1.8, col='black') # Amino Acids
