...
shared_file <- '~/Desktop/Repositories/Jenior_Transcriptomics_2015/data/16S_analysis/all_treatments.0.03.unique_list.shared'
...
pdf(file=plot_file, width=16, height=7)
