...
growth_medians <- as.data.frame(cbind(acetylneuraminate_median, sorbitol_median, fructose_median, combination_median, mannitol_median, salicin_median, y_glucose_y_aa_median, n_glucose_y_aa_median, y_glucose_n_aa_median, n_glucose_n_aa_median, bhi_median))
...
growth_sds <- as.data.frame(cbind(acetylneuraminate_sd, sorbitol_sd, fructose_sd, combination_sd, mannitol_sd, salicin_sd, y_glucose_y_aa_sd, n_glucose_y_aa_sd, y_glucose_n_aa_sd, n_glucose_n_aa_sd, bhi_sd))
...
lines(growth_medians$acetylneuraminate_median, type='o', col='forestgreen', lwd=2.5, pch=19, cex=2.7)
...
legend('topleft', legend=c('+Glucose +AA','Salicin','N-Acetylneuraminate','BHI'), pch=19, cex=2.5, pt.cex=3.5, bg='white',
       col=c('black',wes_palette('FantasticFox')[5],'forestgreen',wes_palette('Darjeeling2')[2]))
