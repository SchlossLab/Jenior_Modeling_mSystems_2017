...
growth_medians <- as.data.frame(cbind(sorbitol_median, fructose_median, combination_median, mannitol_median, salicin_median, y_glucose_y_aa_median, n_glucose_y_aa_median, y_glucose_n_aa_median, n_glucose_n_aa_median, bhi_median))
...
growth_sds <- as.data.frame(cbind(sorbitol_sd, fructose_sd, combination_sd, mannitol_sd, salicin_sd, y_glucose_y_aa_sd, n_glucose_y_aa_sd, y_glucose_n_aa_sd, n_glucose_n_aa_sd, bhi_sd))
...
lines(growth_medians$combination_median, type='o', lwd=2, pch=15, cex=2.7, col=wes_palette('FantasticFox')[1])
