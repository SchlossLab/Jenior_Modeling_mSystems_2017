...
# Axis labels
text(x=-0.38, y=-0.43, labels='Cefoperazone (SPF)', cex=1, col=wes_palette("FantasticFox")[3], font=2)
text(x=-0.18, y=0.53, labels='Clindamycin (SPF)', cex=1, srt=60, col=wes_palette("FantasticFox")[5], font=2)
text(x=0.56, y=-0.12, labels='Streptomycin (SPF)', cex=1, srt=-60, col=wes_palette("FantasticFox")[1], font=2)
...
legend(x=0.23, y=0.7, legend=c('Amino acid catabolism',
                               'Host-derived glycan catabolism',
                               ...
                               'All other genes'), 
       ncol=1, pch=21, pt.cex=c(2,2,2,2,2,2,2,2,1), cex=0.75,
