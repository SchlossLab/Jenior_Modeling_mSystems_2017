...
vege_medians <- c(cef, strep, clinda, gf, conv)
...
spore_medians <- c(cef, strep, clinda, gf, conv)
...
points(x=c(-4,-3,-2.25), y=c(1,1,1), pch=c(25,25,25), bg=c('firebrick','white','black'), col='black', cex=2.5)
