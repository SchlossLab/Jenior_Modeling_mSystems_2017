...
extend to include changes in each important metabolite...
**Concentrations of important metabolites by network analysis in mock and *C. difficile*-infected mouse cecal content.** 



**Supplementary Figure 6 | Within-group population variance for 16S rRNA gene amplicon sequencing and untargeted metabolomic analysis.** **(A)** 16S **(B)** Metabolome
In both groups of calculations all median population variances are below 1, indicating extremely low levels of variability between samples of the same type.
