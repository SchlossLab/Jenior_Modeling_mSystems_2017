...
Conversely, both clindamycin-pretreatment (Fig. 7D) gnotobiotic mice (Fig. 7E) demonstrated a significant correlation between importance scores and \( \Delta \) median scaled intensity (*P* < 0.01). Clindamycin-pretreatment had the greast number of outliers of any single group. 

Proline was ... further supporting it as a...
