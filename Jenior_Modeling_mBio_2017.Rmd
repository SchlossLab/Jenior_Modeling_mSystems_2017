...
Previous transcriptomic efforts to measure the response of *C. difficile* have...

In this study, we employed a mouse model of infection to compare the response of *C. difficile* to colonization of varied gut environments. This allowed us to identify small differences in sporulation and toxin activity between each antibiotic-pretreated condition. Further differences were seen in expression of *C. difficile* metabolic pathways across infection models. Through integration of transcriptomic data with genome-scale metabolic modeling, it was revealed that *C. difficile* likely utilized alternative carbon sources across colonized conditions. We then confirmed modeling-based results with untargeted metabolomic analysis by demonstrating increased availability of many metabolites highlighted by our algorithm. Stickland fermentation substrates were consistently among the highest scoring shared metabolites and were increased in concentration in susceptible environments which then decreased following infection. Host-derived aminoglycans followed an alternative trend...
