...
# Figure 6 data
metabolome <- read.delim('data/wetlab_assays/metabolomics.tsv', sep='\t', header=TRUE)
...
```{r figure_S5, echo=F, warning=F, message=F, results='hide', cache=T}
...
**Mass-spectrometry analysis supports that *C. difficile* consumes metabolites indicated as important by metabolic modeling and supports alternative nutrients niches between models of infection.**
...
...glycine also decreases but relationships are not significant
...
Extremely low variation is both 16S and metabolomic replicates demonstrated that variability between individuals at all levels is likely very low and provided further evidence that RNA-Seq efforts accurately captured the differential transcriptional profile of *C. difficile* in each condition tested (Fig. S7).
