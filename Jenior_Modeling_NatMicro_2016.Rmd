...
**Supplementary Figure 6 | Example Mont-Carlo simulation results for a single metabolite.** Shown here is the result from 10000-fold Monte-Carlo simulation of transcript randomization for enzymes interacting with fructose 1-phosphate alone. These scores were derived from transcriptome of *C. difficile* colonizing streptomycin-treated mice. The black solid line represents the median of the distribution, and the red dotted lines denote the 99% confidence interval. The blue arrow indicates the actual measured score for fructose 1-phosphate in this condition, and has a *P*-value of < 0.01.
